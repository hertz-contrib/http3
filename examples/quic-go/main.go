...
func run() {
	...
	h.GET("/demo/tiles", func(c context.Context, ctx *app.RequestContext) {
		ctx.String(200, "hello world, this is a HTTP/3 response")
	})
	h.GET("/demo/echo", func(c context.Context, ctx *app.RequestContext) {
